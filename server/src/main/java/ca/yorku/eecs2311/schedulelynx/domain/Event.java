...
public class Event {
  ...
  @Column(name = "recurrence_end") private LocalDate recurrenceEnd;

  @ElementCollection(fetch = FetchType.EAGER)
  @CollectionTable(name = "event_recurrence_days",
  ...
  public Event(Long id, String title, LocalDate date, LocalTime startTime,
               LocalTime endTime) {
    this.id = id;
    this.title = title;
    this.date = date;
  ...
  public Event(Long id, String title, LocalDate date, LocalTime startTime,
               ...
               RecurrenceType recurrenceType, LocalDate recurrenceEnd,
    ...
    this.recurrenceDays = recurrenceDays != null ? new HashSet<>(recurrenceDays)
                                                 : new HashSet<>();
  }
  ...
  public Event(String title, LocalDate date, LocalTime startTime,
               LocalTime endTime, boolean recurring,
               RecurrenceType recurrenceType, LocalDate recurrenceEnd,
               Set<DayOfWeek> recurrenceDays, User owner) {
    this.title = title;
    this.date = date;
    this.startTime = startTime;
    this.endTime = endTime;
  ...
  public Set<DayOfWeek> getRecurrenceDays() { return recurrenceDays; }
